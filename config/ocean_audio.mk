...
ALARM_PATH := vendor/ocean/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ocean/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ocean/prebuilt/common/media/audio/ringtones
